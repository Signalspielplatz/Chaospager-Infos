...
For the radio board, we were inspired by the HPD14A modules which are available in china and are used on many Meshtastic compatible boards. So, our radio board was designed in a way that our board can be used as drop-in replacement for those modules. This decision was made mainly as fallback solution if we can't get the radio modules populated in time.
